...
<img src="https://media.giphy.com/media/KtO0lBfNVqcZG/giphy.gif" alt="" style="width:300px; height:270px;  m

---
background-image: url(wallpaper/Diapositiva17.JPG)
background-position: center
background-size: contain
...
library(leaflet)
leaflet() %>% addTiles() %>% setView(-74.051257, 4.673637 ,zoom = 17) 
```
---
background-image: url(Diapositiva17.JPG)
background-position: center
